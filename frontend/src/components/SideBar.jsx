...
function SideBar({ onOpenLogin }) {
                    ...
                    {conversations.map((conv) => {
                        ...
                        return (
                            <div
                                ...
                                ${isActive ? "bg-indigo-500/10 border-indigo-500/[0.18]" : "bg-transparent border-transparent hover:bg-white/[0.03]"}`}
                            >
    ...
    return (
        <>
            <button
                className='lg:hidden fixed top-3.5 left-4 z-40 flex items-center justify-center w-8 h-8 rounded-lg bg-[#0d0f14] border border-white/[0.06] text-slate-400 hover:text-slate-200 transition-colors duration-150 cursor-pointer'
            ...
            >
                <div className='flex flex-col h-full'>
                    <div className='flex items-center gap-2.5 px-4 py-4 border-b border-white/[0.06]'>
                        ...
                        <span className='text-[10px] font-medium text-indigo-400 bg-indigo-500/10 border border-indigo-500/20 px-2 py-0.5 rounded-full tracking-wide uppercase'>
                            {userData?.plan || "free"}
                        </span>
                        <button
                        ...
                        {userData ? (
                            <div className='flex items-center gap-2.5 rounded-xl px-3 py-2.5 hover:bg-white/[0.05] transition-colors duration-150'>
                                ...
                                <div className='flex-1 min-w-0'>
                                    ...
                                    <p className='text-[11px] text-slate-500 mt-px truncate capitalize'>
