...
function Nav() {
  ...
  return (
    <div className='h-14 flex items-center gap-2.5 pl-14 pr-4 lg:px-5 border-b border-white/[0.06] bg-[#0d0f14] shrink-0'>
      ...
      <div className='text-[14px] font-semibold text-slate-100 tracking-tight truncate flex-1'>
